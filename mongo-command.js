...
// we can remove _id like this only id

db.movies.find({rating:{$lt:8.5}},{db.movies.find({rating:{$lte:8.5}},{name:1, rating:1 }),name:1, rating:1 })



// greater than less or equal to  if you add "e"

db.movies.find({rating:{$gte:8.5}},{_id:0,name:1, rating:1 })
...
// movies with rating - 7,8.6,8.8
db.movies.find({rating : {$in: [7,8.6,8.8]}},{_id:0,name:1,rating: 1})


// movies with rating expect this- 7,8.6,8.8
...
// this is range between 8 and 8.5
db.movies.find({rating:{$gt:8 , $lt:8.5 }},{_id:0,name:1, rating:1 })
...
// compound sorting sorting inside sorting
...
db.movies.deleteOne({name:"Interstellar"}  )
db.movies.deleteMany({name:"Interstellar"}  )
